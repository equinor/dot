...
def discrete_conditional_probability_function(
    arg: Any, conditioned_variables: dict, conditioning_variables: dict
) -> dict:
    ...
    arg = arg.astype(float)  # in case of None
    ...
    is_all_nans = np.isnan(arg.astype(float)).all()
...
def discrete_unconditional_probability_function(arg: Any, variables: dict) -> dict:
