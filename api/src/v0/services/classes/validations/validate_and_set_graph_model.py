...
from src.v0.services.classes.node import DecisionNode, NodeABC, UncertaintyNode, UtilityNode
from ..errors import (
...
def arc_to_graph(arg: Any) -> tuple[tuple[NodeABC, NodeABC], dict]:
    ...
    return (arg.tail, arg.head), {"type": arg.dtype, "label": arg.label, "uuid": arg.uuid}