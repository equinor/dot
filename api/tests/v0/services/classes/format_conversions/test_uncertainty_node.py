...
def test_UncertaintyNodeConversion_from_json_uncertainty_other(
        caplog, uncertainty_node
        ):
    local_node = deepcopy(uncertainty_node)
...
def test_UncertaintyNodeConversion_to_json_uncertainty_other(caplog, uncertainty_node):
    ...
    assert str(exc_info.value) == "Data cannot be used to create a UncertaintyNode."
